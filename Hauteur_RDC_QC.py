...
# outFile = laspy.file.File("E:\Charles_Tousignant\Python_workspace\Gari\shapefile\hauteur_RDC\SJSR_2013\output.las", mode="w", header=header)
...
# points_kept = []
# outFile1 = File("E:\Charles_Tousignant\Python_workspace\Gari\shapefile\hauteur_RDC\SJSR_2013\LIDAR_zone_test_petit_1.las", mode="w", header=inFile.header)
#
# print(inFile.points)
#
# for i in range(len(inFile.points)):
